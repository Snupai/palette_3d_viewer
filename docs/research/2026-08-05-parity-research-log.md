...
## Ergänzung 08.09.2026 – Tatsächliche Erweiterung der Mustergeometrien

Die neue begrenzte Familie `crossed-strip` kombiniert ein durchgehendes Rasterband mit quer unterteilten Streifen unterschiedlicher Breite und verteilt Gruppen aus nominalen Einzelpositionen. Direkte Grundflächentreffer der 16 Fälle steigen von 81 auf 109, ohne Verlust bestehender direkter Treffer. Der frisch in MultiPack eingegebene Nachbar 146 × 104 × 139 mm liefert 65 validierte Exporte; dort steigt die Abdeckung von drei auf acht, alle acht ohne Koordinatenabweichung. Die 201-/203-mm-Referenzen bleiben geometrisch unverändert. Details, operative Teilwerte, zusätzliche Solveridentitäten und weiterhin fehlende Geometrien stehen im [Erweiterungsbericht](2026-09-08-multipack-crossed-strips.md). Gesamtsuite mit einem Worker: 793 bestanden, zwei übersprungen; Typecheck und Lint erfolgreich. Keine vollständige Parität und keine Änderung der Corpus-Gates.
