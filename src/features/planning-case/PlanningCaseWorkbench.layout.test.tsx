  ...
  it("contains the planning row and preserves narrow-screen header actions", () => {
    const { container } = render(
      <PlanningCaseWorkbench
        ...
        onApplyReferenceInputs={vi.fn()}
        referenceInputsMatch={false}
        referenceInputDetail="No reference is attached."
        solverResult={null}
        solverInput={null}
        ...
        ledgerRows={[]}
        planFieldMode="overlay"
        onPlanFieldModeChange={vi.fn()}
        currentPalletData={null}
        referenceLayerIndex={0}
        currentLayerIndex={0}
        onReferenceLayerChange={vi.fn()}
