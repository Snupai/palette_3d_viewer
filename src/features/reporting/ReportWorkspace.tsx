...
export function ReportWorkspace({
  ...
  return (
    <div className="print-report report-sheet grid gap-4 border border-zinc-800 bg-zinc-900 p-4 text-zinc-200">
      ...
      <section className="report-section grid gap-3 xl:grid-cols-2">
        <div>
          <h2 className="text-sm font-semibold text-zinc-100">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-zinc-500">
            Fixed right-top preset. A deterministic 2D SVG is used when capture
            is unavailable.
          </p>
            ...
            <tbody>
              {report.robotCycles.rows.map((cycle) => (
                <tr key={cycle.cycleId} className="border-t border-zinc-800">
                  <td className="px-3 py-2 font-mono">{cycle.sequence + 1}</td>
                  <td className="px-3 py-2 font-mono">{cycle.layer}</td>
                  <td className="px-3 py-2 font-mono text-[11px]">
                    {cycle.groupId}
                  </td>
                  <td className="px-3 py-2 font-mono">{cycle.packageCount}</td>
      ...
      <footer className="report-footer border-t border-zinc-700 pt-3">
        <h2 className="text-sm font-semibold text-zinc-100">
          Provenance notes
        </h2>
